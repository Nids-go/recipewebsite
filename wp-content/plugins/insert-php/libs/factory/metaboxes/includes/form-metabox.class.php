<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes409_FormMetabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes409_FormMetabox extends Wbcr_FactoryMetaboxes409_Metabox {
			...
			/**
			 * @var Wbcr_FactoryForms419_MetaValueProvider
			 */
			protected $provider;
			...
			private function getForm($post_id = null)
			{
				...
				$this->provider = new Wbcr_FactoryForms419_MetaValueProvider(array(
					'scope' => $this->scope
				));
				...
				// creating a form
				$form = new Wbcr_FactoryForms419_Form(array(
					'scope' => $this->scope,
					'name' => $this->id
				), $this->plugin);
			...
			public function html()
			{
				...
				echo '<div class="factory-form-metabox factory-bootstrap-422">';
			 ...
			 */
			public function beforeForm(Wbcr_FactoryForms419_Form $form)
			{
				return;
			}
			 ...
			 */
			public function afterForm(Wbcr_FactoryForms419_Form $form)
			{
				return;
			}
