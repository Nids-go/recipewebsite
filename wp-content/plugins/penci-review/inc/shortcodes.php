				...
				<?php if ( $review_title ) : ?>
					<h4 class="penci-review-title" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Thing">
						<a itemprop="url" href="<?php the_permalink(); ?>">
							<span itemprop="name"><?php echo $review_title; ?></span>
						</a>
					</h4>
				<?php endif; ?>
				<?php if ( $review_des ) : ?>
					<div class="penci-review-desc"><p itemprop="description"><?php echo $review_des; ?></p></div>
				<?php endif; ?>
				<span style="display: none !important;" itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php bloginfo( 'name' ); ?></span></span>
					...
					<div class="penci-review-average<?php if ( ! $review_good_array && ! $review_bad_array ) : echo ' full-w'; endif; ?>">
						<div class="penci-review-score-total<?php if( get_theme_mod( 'penci_review_hide_average' ) ): echo ' only-score'; endif; ?>">
							<div class="penci-review-score-num" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
								...
								<span style="display: none !important;" itemprop="ratingValue"><?php echo ( $total_average/2 ); ?></span>
