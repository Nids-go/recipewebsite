	...
	private function select_demo_page() {
		...
		<div class="wrap">
			...
			<div class="updated notice is-dismissible">
				<div class="penci-import-notice" style="text-align: center; padding: 30px 5px;">
					<h3 style="margin-top: 0; font-size: 30px; color: #ff0000;"><?php esc_html_e( ':: NOTE IMPORTANT ::', 'penci_soledad' ) ?></h3>
					<p style="font-size: 17px; color: #864141;"><span style="width: 26px; display: inline-block; height: 26px; background: #2A9C4D; color: #fff; font-weight: bold; border-radius: 50%; margin-right: 10px; -webkit-border-radius: 50%;">1</span> If your site is new site - no any old posts/pages... You can do the import as normal.<br>If your site has old data: posts/pages.. You should not do this because the demo data will appears on your current site...<br>If your site has old data - You should do only <strong>Way 2: Import Only customizer data</strong> like we said on the documentation <a target="_blank" href="http://soledad.pencidesign.com/soledad-document/#import2">here</a></p>
					<p style="font-size: 17px; color: #864141;"><span style="width: 26px; display: inline-block; height: 26px; background: #2A9C4D; color: #fff; font-weight: bold; border-radius: 50%; margin-right: 10px; -webkit-border-radius: 50%;">2</span> If you do import full a demo, please make sure you've installed all plugins come from the theme via <strong>Appearance > Install Plugins</strong></p>
					<p style="font-size: 17px; color: #864141;"><span style="width: 26px; display: inline-block; height: 26px; background: #2A9C4D; color: #fff; font-weight: bold; border-radius: 50%; margin-right: 10px; -webkit-border-radius: 50%;">3</span> Don't import multiple demos for your site. Do import demo for one demo only.<br>If you want to change the demo style to another demo style, check guide <a target="_blank" href="http://soledad.pencidesign.com/soledad-document/#import3">here</a></p>
					<p style="font-size: 17px; color: #864141;"><span style="width: 26px; display: inline-block; height: 26px; background: #2A9C4D; color: #fff; font-weight: bold; border-radius: 50%; margin-right: 10px; -webkit-border-radius: 50%;">4</span> After import a demo ( even you do it with Way 2: Import Only customizer data )<br>Let's go to <strong>Appearance > Menus > create or select a menu for your main navigation > scroll down and check to "Primary Menu" at the bottom.</strong></p>
				</div>
