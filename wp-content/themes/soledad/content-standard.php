...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if( ! get_theme_mod( 'penci_standard_thumbnail' ) ): ?>
		...
		<?php if ( has_post_format( 'link' ) || has_post_format( 'quote' ) ) : ?>
			<div class="standard-post-image standard-post-special<?php if ( has_post_format( 'quote' ) ): ?> penci-special-format-quote<?php endif; ?><?php if ( ! has_post_thumbnail() || get_theme_mod( 'penci_standard_thumbnail' ) ) : echo ' no-thumbnail'; endif; ?>">
