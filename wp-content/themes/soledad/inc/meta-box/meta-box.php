		...
		<?php if ( 'post' == get_post_type( $post->ID ) ) { ?>
			...
			<p>
				<select id="penci_single_style" name="penci_single_style">
					<option value=""><?php esc_html_e( "Default Style( on Customize )", "pencidesign" ); ?></option>
					<option value="style-1" <?php selected( $single_style, 'style-1' ); ?>><?php esc_html_e( "Style 1", "pencidesign" ); ?></option>
					<option value="style-2" <?php selected( $single_style, 'style-2' ); ?>><?php esc_html_e( "Style 2", "pencidesign" ); ?></option>
					<option value="style-3" <?php selected( $single_style, 'style-3' ); ?>><?php esc_html_e( "Style 3", "pencidesign" ); ?></option>
					<option value="style-4" <?php selected( $single_style, 'style-4' ); ?>><?php esc_html_e( "Style 4", "pencidesign" ); ?></option>
					<option value="style-5" <?php selected( $single_style, 'style-5' ); ?>><?php esc_html_e( "Style 5", "pencidesign" ); ?></option>
					<option value="style-6" <?php selected( $single_style, 'style-6' ); ?>><?php esc_html_e( "Style 6", "pencidesign" ); ?></option>
					<option value="style-7" <?php selected( $single_style, 'style-7' ); ?>><?php esc_html_e( "Style 7", "pencidesign" ); ?></option>
					<option value="style-8" <?php selected( $single_style, 'style-8' ); ?>><?php esc_html_e( "Style 8", "pencidesign" ); ?></option>
					<option value="style-9" <?php selected( $single_style, 'style-9' ); ?>><?php esc_html_e( "Style 9", "pencidesign" ); ?></option>
					<option value="style-10" <?php selected( $single_style, 'style-10' ); ?>><?php esc_html_e( "Style 10", "pencidesign" ); ?></option>
				</select>
			</p>
