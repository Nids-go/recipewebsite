<div class="inner-header-social">
	<?php if ( penci_get_setting( 'penci_facebook' ) ) : ?>
		<a href="<?php echo esc_attr( penci_get_setting( 'penci_facebook' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>
	<?php endif; ?>
	<?php if ( penci_get_setting( 'penci_twitter' ) ) : ?>
		<a href="<?php echo esc_attr( penci_get_setting( 'penci_twitter' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-twitter"></i></a>
	<?php endif; ?>
	<?php if ( get_theme_mod( 'penci_google' ) ) : ?>
		<a href="<?php echo esc_attr( get_theme_mod( 'penci_google' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-google-plus"></i></a>
	<?php endif; ?>
