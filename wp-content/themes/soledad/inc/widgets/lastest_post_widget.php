...
if( ! class_exists( 'penci_latest_news_widget' ) ) {
	class penci_latest_news_widget extends WP_Widget {
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' => esc_html__('Recent Posts', 'soledad'), 'image_type' => 'default', 'title_length' => '', 'number' => 5, 'categories' => '', 'featured' => false, 'allfeatured' => false, 'thumbright' => false, 'twocolumn' => false, 'featured2' => false, 'postdate' => false, 'icon' => false );
