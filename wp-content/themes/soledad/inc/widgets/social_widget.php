	...
	class penci_social_widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			<div class="widget-social<?php if( $align ): echo ' '. $align; endif; ?><?php if( $text ): echo ' show-text'; endif; ?><?php if( $circle ): echo ' remove-circle'; endif; ?><?php if( $size_upper ): echo ' remove-uppercase-text'; endif; ?><?php if( $border_radius ): echo ' remove-border-radius'; endif; ?><?php if( $brand_color && ! $circle ){ echo ' penci-social-colored'; } elseif( $brand_color && $circle ){ echo ' penci-social-textcolored'; } ?>">
				<?php if ( $facebook ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_facebook' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-facebook" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Facebook', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $twitter ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_twitter' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-twitter" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Twitter', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $googleplus ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_google' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-google-plus" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Google +', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $instagram ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_instagram' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-instagram" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Instagram', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $pinterest ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_pinterest' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-pinterest" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Pinterest', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $linkedin ) : ?>
					<a href="<?php echo esc_url( get_theme_mod( 'penci_linkedin' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-linkedin" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Linkedin', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $flickr ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_flickr' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-flickr" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Flickr', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $behance ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_behance' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-behance" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Behance', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $tumblr ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_tumblr' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-tumblr" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Tumblr', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $youtube ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_youtube' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-youtube-play" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Youtube', 'soledad' ); ?></span></a>
				<?php endif; ?>
				...
				<?php if ( $vk ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_vk' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-vk" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Vk', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $bloglovin ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_bloglovin' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-heart" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Bloglovin', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $vine ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_vine' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-vine" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Vine', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $soundcloud ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_soundcloud' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-soundcloud" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Soundcloud', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $snapchat ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_snapchat' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-snapchat-ghost" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Snapchat', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $spotify ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_spotify' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-spotify" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Spotify', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $github ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_github' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-github" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Github', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $stack ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_stack' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-stack-overflow" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Stack-Overflow', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $twitch ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_twitch' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-twitch" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Twitch', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $vimeo ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_vimeo' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-vimeo" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Vimeo', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $steam ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_steam' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-steam" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Steam', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $xing ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_xing' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-xing" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Xing', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $whatsapp ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_whatsapp' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-whatsapp" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Whatsapp', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $telegram ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_telegram' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-telegram" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Telegram', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $reddit ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_reddit' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-reddit-alien" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Reddit', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $ok ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_ok' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-odnoklassniki" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Ok', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $px500 ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_500px' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-500px" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( '500px', 'soledad' ); ?></span></a>
				<?php endif; ?>
				
				<?php if ( $stumbleupon ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_stumbleupon' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-stumbleupon" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'StumbleUpon', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $wechat ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_wechat' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-weixin" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Wechat', 'soledad' ); ?></span></a>
				<?php endif; ?>
				
				<?php if ( $weibo ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_weibo' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-weibo" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Weibo', 'soledad' ); ?></span></a>
				<?php endif; ?>

				<?php if ( $rss ) : ?>
					<a href="<?php echo esc_url( get_theme_mod( 'penci_rss' ) ); ?>" rel="nofollow" target="_blank"><i class="fa fa-rss" <?php echo $style_icon; ?>></i><span <?php echo $style_text; ?>><?php esc_html_e( 'RSS', 'soledad' ); ?></span></a>
				<?php endif; ?>
			</div>
