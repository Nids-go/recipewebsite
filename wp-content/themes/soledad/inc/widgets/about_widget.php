		...
		function widget( $args, $instance ) {
			...
			<div class="about-widget<?php if( $align ): echo ' ' . $align; endif; ?>">
				<?php if ( $image ) : ?>
					<?php echo $open_image; ?>
					<?php if( ! $lazyload ) { ?>
						<img <?php if( $imagemaxwidth ): echo 'style="max-width: '. $imagemaxwidth .'px !important;" '; endif; ?>class="penci-widget-about-image nopin holder-square penci-lazy" nopin="nopin" src="<?php echo get_template_directory_uri() . '/images/penci2-holder.png'; ?>" data-src="<?php echo esc_url( $image ); ?>" alt="<?php echo esc_attr( $title ); ?>"<?php echo $circle_style; ?>/>
					<?php } else { ?>
						<img <?php if( $imagemaxwidth ): echo 'style="max-width: '. $imagemaxwidth .'px !important;" '; endif; ?>class="penci-widget-about-image nopin holder-square" nopin="nopin" src="<?php echo esc_url( $image ); ?>" alt="<?php echo esc_attr( $title ); ?>"<?php echo $circle_style; ?>/>
					<?php }?>
